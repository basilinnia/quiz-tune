...
const customTheme = createTheme({
  card: {
    root: {
      base: "rounded-xl shadow-xl drop-shadow-xl/80 dark:bg-yellow-500 bg-gray-400",
...
export default function Page() {
    return (
        <ThemeProvider theme={customTheme}>
            <div className="bg-[url(../../public/backgrounds/3.png)] bg-cover bg-center h-screen flex flex-col w-full items-center">
                <Navbar/>
                <Card className="w-1/2 mx-auto h-1/12 mb-8">
                    <h1 className="font-bold text-xl text-center py-4">Name the song!</h1>
                </Card>
